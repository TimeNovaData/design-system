<template>
  ...
  <div class="container relative">
    ...
    <section id="tasks" class="bg-neutral-10">
              ...
              <div class="grid grid-cols-1 gap-2 py-4">
                <div class="">
                  <div class="base-grid px-16">
                    ...
                    <p class="text-headline-3 pl-16">Responsável</p>
...
.base-grid
  display: grid
  grid-template-columns: minmax(55px, 65px)  minmax(200px, 1fr) minmax(170px, 204px) repeat(3, 100px) minmax(120px, 130px)
  align-items: center
</style>
