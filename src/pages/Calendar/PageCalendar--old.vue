  ...
  <q-scroll-area>
    <div class="container relative">
      ...
      >
        ...
        <!-- <BaseCalendar2 /> -->
        <div>
          <div class="flex items-end w-full flex-nowrap mt-32 mb-16 relative">
            <NavigationBar @today="onToday" @prev="onPrev" @next="onNext" />
            <p
              class="capitalize text-title-3 text-neutral-70 dark:text-white/80 ml-24"
            >
              {{ formattedMonth }}
            </p>
            ...
            <div style="display: flex; width: 100%">
              ...
              >
                ...
                <template #week="{ scope: { week, weekdays } }">
                  <template
                    v-for="(computedEvent, index) in (week, weekdays)"
                    :key="index"
                  >
                    <div
...
.calendario
  --calendar-border-dark: .0625rem solid rgba(var(--white),0.15 )
  --calendar-border-current-dark:.0625rem solid rgb(var(--primary-pure))
  --calendar-current-color-dark: rgb(var(--primary-pure))

  --calendar-border-current:.0625rem solid rgb(var(--primary-pure))
