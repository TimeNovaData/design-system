<template>
  <q-header class="kanban-header">
    <div class="flex items-center justify-between w-full">
      ...
      <q-tabs v-model="tab" class="text-neutral-100 dark:text-white/90 text-paragraph-1 w-max mx-auto"
      ...
      <div class="flex gap-8 text-white/80">
        ...
        <OButton size="sm" secondary class="bg-white/10 !py-0 !h-32 !border-transparent">
          <q-icon size="1.5rem" name="svguse:/icons.svg#icon_filter"></q-icon>
          Filtro
        </OButton>
        <OButton size="sm" secondary class="bg-white/10 !py-0 !h-32 !border-transparent">
          <q-icon size="1.5rem" name="svguse:/icons.svg#icon_visualizacao"></q-icon>

          Visualização
        </OButton>
        <OButton size="sm" secondary class="bg-white/10 !p-0 !h-32 !border-transparent !w-32">
          <q-icon size="1.5rem" name="svguse:/icons.svg#icon_tree_points"></q-icon>
