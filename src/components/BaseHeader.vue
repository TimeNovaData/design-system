  ...
  <q-header class="base-header">
    <div class="flex items-center justify-between w-full">
      ...
      <q-breadcrumbs separator=">">
        ...
        <q-breadcrumbs-el label="Kanban" :exact="true" :to="{ name: 'kanban' }" />
      </q-breadcrumbs>

      <div class="flex gap-8 items-center" style="--neutral-100: var(--white);">
        <OInput size="sm" placeholder="Busque por chamado, projeto.." class="no-label text-white/70" type="search"
        ...
        <!-- settings -->
        <OButton class="text-neutral-10 w-32 h-32 !p-0 bg-white/10 !border-transparent" secondary size="sm">
        ...
        <OButton class="text-neutral-10 w-32 h-32 !p-0" tertiary rounded size="sm">
